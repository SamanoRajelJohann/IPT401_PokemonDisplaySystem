            ...
            <div class="col-lg-6 bg-white">
              <div class="d-flex align-items-center px-4 px-lg-5 h-100 bg-gray-300">
                <form class="register-form py-5 w-100" method="post" action="">
                  ...
                  <button class="btn btn-primary mb-3" id="register" type="submit">Register</button><br><small class="text-dash-color-3">Already have an account?</small> <a class="text-sm text-paleBlue" href="index.php">Login</a>
                </form>
              </div>
            </div>
          </div>
