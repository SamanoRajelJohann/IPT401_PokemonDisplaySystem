        ...
        <div class="col-lg-6">
          ...
          <div class="col-lg-6 bg-white">
            <div class="d-flex align-items-center px-4 px-lg-5 h-100 bg-gray-300">
              <form class="login-form py-5 w-100" method="post" action="home.html">
                <div class="input-material-group mb-3">
                  <input class="input-material" id="login-email" type="text" name="loginEmail" autocomplete="off" required data-validate-field="loginEmail">
